...
print("madmaxcddd${widget.layout}");
...
typeList = buildGridViewProduct2(
  products: productsList,
  widthContent: widthScreen, crossAxisCount: crossAxisCount,
);
// }else {
//
...
child: ColoredBox(
  color: Theme.of(context).brightness == Brightness.dark? Theme.of(context).colorScheme.background : Colors.grey[200]!,
...
Widget buildGridViewProduct2({
  ...
  return SliverPadding(
    ...
    sliver: SliverMasonryGrid.count(
      ...
      childCount: products!.length,
      itemBuilder: (context, i) =>  Services().widget.renderProductCardView2(
      item: products[i],
      width: widthContent,
      // ratioProductImage: widget.ratioProductImage ?? 1.2,
      ratioProductImage:.5,
      config: ProductConfig.empty()..showCatigory=true
        ..showHeart = true
        ..imageRatio = widget.ratioProductImage ?? 1.2
        ..showCountDown = kSaleOffProduct.showCountDown &&
            widget.layout == Layout.saleOff

...
import 'index.dart'
    show CartButton, CartIcon, CartQuantity, HeartButton, ProductImage, ProductOnSale, ProductPricing, ProductPricing2, ProductRating, ProductTitle, SaleProgressBar, StockStatus, StoreName;
...
class ProductCard2 extends StatefulWidget {
  ...
  @override
  State<ProductCard2> createState() => _ProductCardState2();
}

class _ProductCardState2 extends State<ProductCard2> with ActionButtonMixin {
  int _quantity = 1;

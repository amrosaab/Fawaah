...
typedef SendCodeFunction = Future<void> Function({
required String username,
required Function(bool success) success,
required Function(String message) fail,
});

typedef LoginWithCodeFunction = Future<void> Function({
required String username,
...
mixin LoginMixin<T extends StatefulWidget> on BaseScreen<T> {
  ...
  LoginSocialFunction get _loginApple => _userModel.loginApple;
  LoginSocialFunction get _loginGoogle => _userModel.loginGoogle;
  SendCodeFunction get _sendCode => _userModel.sendCode;
  LoginWithCodeFunction get _loginWithCode => _userModel.loginWithCode;
  AudioManager get _audioPlayerService => injector<AudioManager>();
  ...
  Future<void> loginWithVerificationCode(String username, String code) async {

                ...
                builder: (context, totalCartQuantity, child) {
                  ...
                  return Row(
                    children: [
                      totalCartQuantity > 0
                          ? (isLoading
                          ? Text(S.of(context).loading.toUpperCase(),style: TextStyle(                          fontFamily: GoogleFonts.cairo().fontFamily,))
                          : Text(S.of(context).checkout.toUpperCase(),style: TextStyle(                          fontFamily: GoogleFonts.cairo().fontFamily,),))
                          : Text(S.of(context).startShopping.toUpperCase(),style: TextStyle(                          fontFamily: GoogleFonts.cairo().fontFamily,)),

...
class _MyCartState extends State<MyCart> with SingleTickerProviderStateMixin {
    ...
    return MediaQuery.removePadding(
      ...
      child: Scaffold(
        ...
        floatingActionButton:
            Selector<CartModel, (bool, Map<String?, Product?>, bool, int)>(
                  ...
                  ? () async {
                      ...
                      var isLoggedIn =
                          Provider.of<UserModel>(context, listen: false)
                              .loggedIn;
                      if (!isLoggedIn) {
                        final forceLogin = await chackoutLogin(context);
                        if (forceLogin != null) {
                          if (forceLogin) {
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                ...
                                if (totalCartQuantity == 0)
                                  EmptyCart(isModal: widget.isModal),
                                if (errMsg.isNotEmpty)
                                  Padding(
                                    ...
                                    child: Text(
                                      // errMsg
                                      S.of(context).sureThatProductExists,
  ...
  Future<bool?> chackoutLogin(context) async {
